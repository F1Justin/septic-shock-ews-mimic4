...
MIMIC-IV data were provided by PhysioNet \cite{goldberger2000}.

\section*{Declarations}

\subsection*{Ethics approval and consent to participate}
MIMIC-IV v3.1 is a de-identified, publicly available critical care database.
The original data collection at Beth Israel Deaconess Medical Center was
approved by the Institutional Review Board (IRB), which granted a waiver of
informed consent owing to the retrospective and de-identified nature of the
data.
Access to MIMIC-IV was obtained by C.F.\ under PhysioNet's standard
Credentialed Health Data Licence following completion of the CITI
``Data or Specimens Only Research'' training programme
(Record ID: 75937586; completed 16 March 2026; valid until 16 March 2029;
score 97\%; verifiable at
\url{https://www.citiprogram.org/verify/?ke27fd37e-2675-475a-a266-2fee671ede6f-75937586}).
...
curation, Writing~-- original draft, Visualization, and manuscript revision.
H.Y.: Discussion of the proposed research idea, correspondence, and
coordination of independent clinical review of the manuscript.
Q.L.: Critical clinical review of the manuscript, expert adjudication of
the septic shock definition and physiological rigidity framework, and
supervision of the clinical interpretation.
