...
\url{https://github.com/F1Justin/septic-shock-ews-mimic4} (MIT licence).
MIMIC-IV v3.1 is available via PhysioNet
...
included in the code repository per the Data Use Agreement.
