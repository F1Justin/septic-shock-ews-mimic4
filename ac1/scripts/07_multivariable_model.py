...
def load_ews_features(suffix: str = "") -> pd.DataFrame:
    ...
    """
    wins   = pd.read_parquet(tagged_path(NAAS_ROOT / "data" / "ews_windows.parquet", suffix))
    pstats = pd.read_parquet(tagged_path(NAAS_ROOT / "data" / "ews_patient_stats.parquet", suffix))
